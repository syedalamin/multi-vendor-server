...
const createDataIntoDB = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result = yield review_services_1.ReviewServices.createDataIntoDB(id, req);
...
const getAllDataFromDB = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield review_services_1.ReviewServices.getAllDataFromDB();
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
...
const getByIdFromDB = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result = yield review_services_1.ReviewServices.getByIdFromDB(id);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        message: "Review are retrieved successfully",
        data: result,
...
const updateByIdIntoDB = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield review_services_1.ReviewServices.updateByIdIntoDB();
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
...
const deleteByIdFromDB = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield review_services_1.ReviewServices.deleteByIdFromDB();
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
